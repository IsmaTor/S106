...
public class GenericMethods <T, S, U> {
	...
	//constructor
	public GenericMethods(T gen1, S gen2, int gen3) {
		this.gen1 = gen1;
		this.gen2 = gen2;
		this.gen3 = gen3;
	}
	...
	public void veureGenerics(T gen1, S gen2, int gen3) { //li diem que agafi T,S,U dins del mètode i desprès els mostri.
